 ...
 *
 */
class Tx_CsPowermailLimit_Limit extends Tx_Powermail_Controller_FormsController
{
    ...
    function checkLimit($forms, $caller)
    {
        ...
        $content_start_msg
            = $this->settings['flexform']['start']['message'];      // possible Content (RTE Message) Maillimit
        // endlimits
        ...
        $content_end_msg
            = $this->settings['flexform']['end']['message'];        // possible Content (RTE Message) Maillimit
